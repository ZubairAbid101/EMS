                      ...
                      <td>
                        {leave.status === "PENDING" && (
                          <div className="flex justify-center gap-2">
                            {/* Approved Button */}
                            <button
                              className="p-1.5 rounded-md bg-emerald-50 text-emerald-600 hover:bg-emerald-100 transition-colors duration-200"
                              onClick={() =>
                                handleStatusUpdate(
                                  leave._id || leave.id,
                                  "APPROVED",
                            ...
                            {/* Rejected Button */}
                            <button
                              className="p-1.5 rounded-md bg-rose-50 text-rose-600 hover:bg-rose-100 transition-colors duration-200"
                              onClick={() =>
                                handleStatusUpdate(
                                  leave._id || leave.id,
                                  "REJECTED",
